...
class PreferencesPhotobombDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesPhotobombDialog"
    prefernces = {}

    def __init__(self):
        """__init__ - This function is typically not called directly.
        Creation of a PreferencesPhotobombDialog requires redeading the associated ui
        file and parsing the ui definition extrenally,
        and then calling PreferencesPhotobombDialog.finish_initializing().

        Use the convenience function NewPreferencesPhotobombDialog to create
    ...
    def get_preferences(self):
        ...
        preferences for photobomb. Creates a couchdb record if
        necessary.
        """
...
def NewPreferencesPhotobombDialog():
    """NewPreferencesPhotobombDialog - returns a fully instantiated
    PreferencesPhotobombDialog object. Use this function rather than
    creating a PreferencesPhotobombDialog instance directly.
    """

    #look for the ui file that describes the ui
    ui_filename = os.path.join(getdatapath(), 'ui', 'PreferencesPhotobombDialog.ui')
    if not os.path.exists(ui_filename):
        ui_filename = None

    builder = gtk.Builder()
    builder.add_from_file(ui_filename)
    dialog = builder.get_object("preferences_photobomb_dialog")
    dialog.finish_initializing(builder)
    return dialog

if __name__ == "__main__":
    dialog = NewPreferencesPhotobombDialog()
    dialog.show()
    gtk.main()
